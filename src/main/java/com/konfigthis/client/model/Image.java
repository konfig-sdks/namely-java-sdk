...
public class Image {
  ...
  **/
  ...
  @ApiModelProperty(value = "unique identifier of the image")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "image's file name")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "link of image with original resolution")
  ...
  public Image thumbs(Thumb thumbs) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      // validate the optional field `thumbs`
      if (jsonObj.get("thumbs") != null && !jsonObj.get("thumbs").isJsonNull()) {
        Thumb.validateJsonObject(jsonObj.getAsJsonObject("thumbs"));
      }
  }
