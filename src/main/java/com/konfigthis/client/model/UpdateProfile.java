...
public class UpdateProfile {
  ...
  private List<UpdateProfilePayload> profiles = new ArrayList<>();

  public UpdateProfile() {
  }

  public UpdateProfile profiles(List<UpdateProfilePayload> profiles) {
  ...
  public UpdateProfile addProfilesItem(UpdateProfilePayload profilesItem) {
  ...
  **/
  ...
  public List<UpdateProfilePayload> getProfiles() {
    return profiles;
  }


  public void setProfiles(List<UpdateProfilePayload> profiles) {
   ...
   * @return the UpdateProfile instance itself
   */
  public UpdateProfile putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.profiles, updateProfile.profiles)&&
        Objects.equals(this.additionalProperties, updateProfile.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateProfile
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateProfile.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArrayprofiles.size(); i++) {
        UpdateProfilePayload.validateJsonObject(jsonArrayprofiles.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateProfile>() {
           ...
           public UpdateProfile read(JsonReader in) throws IOException {
             ...
             UpdateProfile instance = thisAdapter.fromJsonTree(jsonObj);
