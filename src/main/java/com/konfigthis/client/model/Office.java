 ...
 */
@ApiModel(description = "these fields represent the entire office address and are inherited from the \"Office Location\" group assigned to the profile")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Office {
  ...
  **/
  ...
  @ApiModelProperty(value = "address line 1 of the office address")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "address line 2 of the office address")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "city of the office address")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "state of the office address; for US, must be the 2-digit code; for other countries, refer to the #docTextSection:7izuT4kPbi3FngZbD endpoints")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "zip or postal code of the office address")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "phone number associated with the office location")
   ...
   * @return the Office instance itself
   */
  public Office putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address1, office.address1) &&
        ...
        Objects.equals(this.zip, office.zip) &&
        Objects.equals(this.phone, office.phone)&&
        Objects.equals(this.additionalProperties, office.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address1, address2, city, stateId, countryId, zip, phone, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Office>() {
           ...
           public Office read(JsonReader in) throws IOException {
             ...
             Office instance = thisAdapter.fromJsonTree(jsonObj);
