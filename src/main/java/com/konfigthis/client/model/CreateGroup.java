...
public class CreateGroup {
  ...
  private List<CreateGroupPayload> groups = new ArrayList<>();

  public CreateGroup() {
  }

  public CreateGroup groups(List<CreateGroupPayload> groups) {
  ...
  public CreateGroup addGroupsItem(CreateGroupPayload groupsItem) {
  ...
  **/
  ...
  public List<CreateGroupPayload> getGroups() {
    return groups;
  }


  public void setGroups(List<CreateGroupPayload> groups) {
   ...
   * @return the CreateGroup instance itself
   */
  public CreateGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.groups, createGroup.groups)&&
        Objects.equals(this.additionalProperties, createGroup.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateGroup
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArraygroups.size(); i++) {
        CreateGroupPayload.validateJsonObject(jsonArraygroups.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateGroup>() {
           ...
           public CreateGroup read(JsonReader in) throws IOException {
             ...
             CreateGroup instance = thisAdapter.fromJsonTree(jsonObj);
