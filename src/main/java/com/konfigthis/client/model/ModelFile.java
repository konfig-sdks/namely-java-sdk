...
public class ModelFile {
  ...
  **/
  ...
  public ModelFile original(String original) {
  ...
  **/
  ...
  public ModelFile thumbs(List<Thumb> thumbs) {
  ...
  public ModelFile addThumbsItem(Thumb thumbsItem) {
    if (this.thumbs == null) {
      this.thumbs = new ArrayList<>();
    }
    this.thumbs.add(thumbsItem);
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, _file.id) &&
        ...
        Objects.equals(this.original, _file.original) &&
        Objects.equals(this.thumbs, _file.thumbs)&&
        Objects.equals(this.additionalProperties, _file.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, filename, mimeType, original, thumbs, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("thumbs") != null && !jsonObj.get("thumbs").isJsonNull()) {
        JsonArray jsonArraythumbs = jsonObj.getAsJsonArray("thumbs");
        if (jsonArraythumbs != null) {
          // ensure the json data is an array
          if (!jsonObj.get("thumbs").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `thumbs` to be an array in the JSON string but got `%s`", jsonObj.get("thumbs").toString()));
          }

          // validate the optional field `thumbs` (array)
          for (int i = 0; i < jsonArraythumbs.size(); i++) {
            Thumb.validateJsonObject(jsonArraythumbs.get(i).getAsJsonObject());
          };
        }
      }
  }
